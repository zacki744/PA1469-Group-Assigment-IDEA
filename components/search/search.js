...
import PDF_View from './../produktView/pdf_view.js';
...
export default function Search() {
  ...
  if (redirectAbles === 1) {
    return <ProduktView produktID={search} setredirectAbles={setredirectAbles} />;
  } else if (redirectAbles === 2) {
    return <Support produktID={search} setredirectAbles={setredirectAbles} />;
  } else if (redirectAbles === 3) {
    return <PDF_View produktID={search} setredirectAbles={setredirectAbles} />;
  } else if (redirectAbles === 4){
    return <Receipt produktID={search} setredirectAbles={setredirectAbles}/>;
  }
    else {
      return (
